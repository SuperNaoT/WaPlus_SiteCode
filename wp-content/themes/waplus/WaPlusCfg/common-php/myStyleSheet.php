<?php
  ...
  if ( ! is_admin() ) {
    ...
    function add_myStyleSheet() {
      ...
      $handle = 'resetCss';
      // 追加したいCSSのURL.
      $src = get_template_directory_uri().'/WaPlusCfg/assets/clearEnvStyle.min.css';
      ...
      $deps = array('resetCss');
      // 追加したいCSSのURL.
      $src = get_template_directory_uri().'/WaPlusCfg/assets/hbgMenu.min.css';
      // CSSファイル取込実行
      wp_enqueue_style( $handle, $src, $deps, $ver, $media );
      ...
      if ( is_single() || is_archive() )  {
        ...
        $deps = array();
        // 追加したいCSSのURL.
        $src = get_template_directory_uri().'/WaPlusCfg/assets/scss/common-style/archive/style.min.css';
        // CSSファイル取込実行
        wp_enqueue_style( $handle, $src, $deps, $ver, $media );
        ...
        if ( is_single() )  {
          ...
          // 追加したいCSSのURL.
          $src = get_template_directory_uri().'/WaPlusCfg/assets/scss/common-style/archive/forWordPressEditor.min.css';
          // CSSファイル取込実行
          wp_enqueue_style( $handle, $src, $deps, $ver, $media );
      ...
      // 「メインページ（front-page.php）から固定ページ関連」
        ...
        if ( is_home() )  {
          ...
          // 追加したいCSSのURL.
          $src = get_template_directory_uri().'/WaPlusCfg/assets/scss/contents/00_index/style.min.css';
          // CSSファイル取込実行
          wp_enqueue_style( $handle, $src, $deps, $ver, $media );
        ...
        // **************************************************
          ...
          $deps = array( 'hbgMenu_css' );
          // 追加したいCSSのURL.
          $src = get_template_directory_uri().'/WaPlusCfg/assets/scss/contents/404/style.min.css';
          // CSSファイル取込実行
          wp_enqueue_style( $handle, $src, $deps, $ver, $media );
        ...
        // **************************************************
          ...
          $deps = array( 'hbgMenu_css' );
          // 追加したいCSSのURL.
          $src = get_template_directory_uri().'/WaPlusCfg/assets/scss/contents/01_philo/style.min.css';
          // CSSファイル取込実行
          wp_enqueue_style( $handle, $src, $deps, $ver, $media );
        ...
        // **************************************************
          ...
          $deps = array( 'hbgMenu_css' );
          // 追加したいCSSのURL.
          $src = get_template_directory_uri().'/WaPlusCfg/assets/scss/contents/02_mngSup/style.min.css';
        ...
        // **************************************************
          ...
          $deps = array( 'hbgMenu_css' );
          // 追加したいCSSのURL.
          $src = get_template_directory_uri().'/WaPlusCfg/assets/scss/contents/03_itWebS/style.min.css';
          // CSSファイル取込実行
          wp_enqueue_style( $handle, $src, $deps, $ver, $media );
        ...
        // **************************************************
          ...
          $deps = array( 'hbgMenu_css' );
          // 追加したいCSSのURL.
          $src = get_template_directory_uri().'/WaPlusCfg/assets/scss/contents/04_orGods/style.min.css';
          // CSSファイル取込実行
          wp_enqueue_style( $handle, $src, $deps, $ver, $media );
        ...
        // **************************************************
          ...
          $deps = array( 'hbgMenu_css' );
          // 追加したいCSSのURL.
          $src = get_template_directory_uri().'/WaPlusCfg/assets/scss/contents/05_iNekka/style.min.css';
          // CSSファイル取込実行
          wp_enqueue_style( $handle, $src, $deps, $ver, $media );
        ...
        // **************************************************
          ...
          $deps = array( 'hbgMenu_css' );
          // 追加したいCSSのURL.
          $src = get_template_directory_uri().'/WaPlusCfg/assets/scss/contents/06_ACestus/style.min.css';
          // CSSファイル取込実行
          wp_enqueue_style( $handle, $src, $deps, $ver, $media );
        ...
        // **************************************************
          ...
          $deps = array( 'hbgMenu_css' );
          // 追加したいCSSのURL.
          $src = get_template_directory_uri().'/WaPlusCfg/assets/scss/contents/07_news/style.min.css';
          // CSSファイル取込実行
          wp_enqueue_style( $handle, $src, $deps, $ver, $media );
        ...
        // **************************************************
          ...
          $deps = array( 'hbgMenu_css' );
          // 追加したいCSSのURL.
          $src = get_template_directory_uri().'/WaPlusCfg/assets/scss/contents/08_blog/style.min.css';
          // CSSファイル取込実行
          wp_enqueue_style( $handle, $src, $deps, $ver, $media );
        ...
        // **************************************************
          ...
          $deps = array( 'hbgMenu_css' );
          // 追加したいCSSのURL.
          $src = get_template_directory_uri().'/WaPlusCfg/assets/scss/contents/09_comProf/style.min.css';
          // CSSファイル取込実行
          wp_enqueue_style( $handle, $src, $deps, $ver, $media );
        ...
        // **************************************************
          ...
          $deps = array( 'hbgMenu_css' );
          // 追加したいCSSのURL.
          $src = get_template_directory_uri().'/WaPlusCfg/assets/scss/contents/10_pPolicy/style.min.css';
        ...
        // **************************************************
          ...
          $deps = array( 'hbgMenu_css' );
          // 追加したいjQueryのURL.
          $src = get_template_directory_uri().'/WaPlusCfg/assets/scss/contents/11_contactF/style.min.css';
