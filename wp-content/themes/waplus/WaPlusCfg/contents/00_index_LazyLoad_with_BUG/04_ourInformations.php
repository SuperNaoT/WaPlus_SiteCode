      ...
      <section id="OurInformation">
        ...
        <?php endif; ?>
          <div class="baseFrame forPC">
            <img loading="lazy" src="<?php echo esc_url( get_template_directory_uri().'/WaPlusCfg/Images/ACestus/ACestus-bangkok1M.jpg' ) ?>" alt="オリジナル商品販売事業・アフロディーテケストスでのビズトリップで訪れたバンコクのレストラン「Baan Chidlom Bangpu」の画像"> 
          </div>
          <div class="baseFrame forMB">
            <img loading="lazy" src="<?php echo esc_url( get_template_directory_uri().'/WaPlusCfg/Images/ACestus/ACestus-bangkok1Px.jpg' ) ?>" alt="オリジナル商品販売事業・アフロディーテケストスでのビズトリップで訪れたバンコクのレストラン「Baan Chidlom Bangpu」の画像"> 
          </div>
        </div>
      </section>
