...
<!-- ********************************************* -->
            ...
            <div class="panel js-panel" id="OurPerformanceACestus">
              ...
              <?php endif; ?>
                <div class="baseFrame">
                  <img loading="lazy" src="<?php echo esc_url( get_template_directory_uri().'/WaPlusCfg/Images/ACestus/ACestus-500x350.jpg' ) ?>" alt="オリジナル商品販売事業・アフロディーテケストス、クロコダイル原皮の美しさと品を象徴した画像">      
                </div>
              </div>  
            </div>
