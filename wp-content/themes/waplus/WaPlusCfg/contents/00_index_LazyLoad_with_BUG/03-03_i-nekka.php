...
<!-- ********************************************* -->
            ...
            <div class="panel js-panel" id="OurPerformanceInekka">
              ...
              <?php endif; ?>
                <div class="baseFrame">
                  <img loading="lazy" src="<?php echo esc_url( get_template_directory_uri().'/WaPlusCfg/Images/i-nekka/i-nekka-roses.jpg' ) ?>" alt="オリジナル商品販売事業・いーねっか、レース編みにて作成したローズを寄せ集めた作品の画像">
                </div>
              </div>  
            </div>
