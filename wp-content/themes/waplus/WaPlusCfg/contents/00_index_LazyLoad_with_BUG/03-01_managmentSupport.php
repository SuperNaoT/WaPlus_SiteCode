...
<!-- ********************************************* -->
            ...
            <div class="panel js-panel" id="OurPerformance">
              ...
              <?php endif; ?>
                <div class="baseFrame">
                  <img loading="lazy" class="forPC" src="<?php echo esc_url( get_template_directory_uri().'/WaPlusCfg/Images/SunShine.jpg' ) ?>" alt="経営支援にて前途が開け希望に満ちる創業者の気持ちを表現した神宮球場バックネット裏から仰ぐ眩しい太陽の画像">
                  <img loading="lazy" class="forMB" src="<?php echo esc_url( get_template_directory_uri().'/WaPlusCfg/Images/SunShineW.jpg' ) ?>" alt="経営支援にて前途が開け希望に満ちる創業者の気持ちを表現した神宮球場バックネット裏から仰ぐ眩しい太陽の画像">
                </div>
              </div>  
            </div>
