...
*/
  ...
  global $GB_categoryType;
         $GB_categoryType = $DEF_catID_blog;
?>
      ...
      <section id="rollingTitlePage">
        <div class="container" style="overflow: hidden;">
          ...
          <!-- イメージ画像表示 -->
          <div class="blogLargeLogo" id="blogLgLogoImage"></div>
              ...
              <?php if ( !$GB_MOBILE_FLAG ): ?>
                <div class="msgDetailPC">
                  ...
                  <?php
                    ...
                    // echo " ? 【subPage-08.php】\$category Type  【". $GB_categoryType . "】<br>";
                    // echo " ? 【subPage-08.php】\$category Count 【". $cateCount . "】<br>";
                  ?>
