...
<!-- ********************************************* -->
            ...
            <div class="panel js-panel" id="OurPerformance">
              ...
              <?php endif; ?>
                <div class="baseFrame">
                  <img class="forPC" src="<?php echo esc_url( get_template_directory_uri().'/WaPlusCfg/Images/SunShine.jpg' ) ?>" alt="IT WEB Solイメージ">
                  <img class="forMB" src="<?php echo esc_url( get_template_directory_uri().'/WaPlusCfg/Images/SunShineW.jpg' ) ?>" alt="IT WEB Solイメージ">
                </div>
              </div>  
            </div>
