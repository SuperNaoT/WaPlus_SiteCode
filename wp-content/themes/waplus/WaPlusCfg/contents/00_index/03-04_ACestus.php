...
<!-- ********************************************* -->
            ...
            <div class="panel js-panel" id="OurPerformanceACestus">
              ...
              <?php endif; ?>
                <div class="baseFrame">
                  <img src="<?php echo esc_url( get_template_directory_uri().'/WaPlusCfg/Images/ACestus/ACestus-500x350.jpg' ) ?>" alt="ACestus メイン">      
                  <!-- <img class="forPC" src="<?php //echo esc_url( get_template_directory_uri().'/WaPlusCfg/Images/ACestus/ACestus-500x350.jpg' ) ?>" alt="ACestus メイン">       -->
                  <!-- <img class="forMB" src="<?php //echo esc_url( get_template_directory_uri().'/WaPlusCfg/Images/ACestus/ACestus-500x350Px.jpg' ) ?>" alt="ACestus メイン">       -->
                </div>
              </div>  
            </div>
