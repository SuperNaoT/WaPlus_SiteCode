...
<!-- ********************************************* -->
            ...
            <div class="panel js-panel" id="OurPerformanceInekka">
                  ...
                  <?php //if ( !$GB_MOBILE_FLAG ): ?>
                    <div class="msgDetailPC forPC">
                      <p>　人と繋がっていたい！<br>
                        ...
                        　一つ一つ想いを込めて丁寧に作っています。
                        　<a href="<?php echo esc_url( home_url('05_inekka') ); ?>">[ ... <i class="fas fa-info colBlue"></i> <i class="fas fa-link extLnkIcon colBlue"></i> ]</a></p>
              ...
              <?php endif; ?>
                <div class="baseFrame">
                  <img src="<?php echo esc_url( get_template_directory_uri().'/WaPlusCfg/Images/i-nekka/i-nekka-roses.jpg' ) ?>" alt="いーねっか、ローズ">
                  <!-- <img class="forPC" src="<?php //echo esc_url( get_template_directory_uri().'/WaPlusCfg/Images/i-nekka/i-nekka-roses.jpg' ) ?>" alt="いーねっか、ローズ"> -->
                  <!-- <img class="forMB" src="<?php //echo esc_url( get_template_directory_uri().'/WaPlusCfg/Images/i-nekka/i-nekka-rosesPx.jpg' ) ?>" alt="いーねっか、ローズ"> -->
                </div>
              </div>  
            </div>
