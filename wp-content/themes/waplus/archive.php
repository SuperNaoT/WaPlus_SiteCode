...
*/
  ...
  $postYearMonth  = get_the_date('Y年m月');
  ...
  // if ( $GB_categoryType == $DEF_catName_news )  {
  ...
  // } else if ( $GB_categoryType == $DEF_catName_blog )  {
  if ( $GB_categoryType == $DEF_catName_blog )  {
    ...
    "<span>B</span>
     ...
     <span>v</span>
     <span>e</span>";
    $args_cthCopy   = "月別投稿【" . $postYearMonth . "】" ;
    $args_cthCopyMB = "月別投稿【" . $postYearMonth . "】" ;

  } else if ( $GB_categoryType == $DEF_catName_tech )  {
    ...
    "<span>T</span>
     ...
     <span>p</span>
     <span>s</span>";
    // $args_cthCopy   = "月別アーカイブ【" . $postYearMonth . "】" ;
    $args_cthCopy   = "月別投稿【" . $postYearMonth . "】" ;
    $args_cthCopyMB = "月別投稿【" . $postYearMonth . "】" ;

} else if ( $GB_categoryType == $DEF_catName_howTo )  {
